...
\##Count the number of times each token appears \##Visualize the top 20
most frequent words \##Explain what we see from this result. Does it
makes sense? What insights (if any) do we get?
